...
const translations = {
	en: {
		...
		'footer-hours-desc': '<b>We are open every day:</b> 10:00 AM - 9:00 PM',
	...
	ru: {
		...
		'footer-hours-desc': '<b>Работаем ежедневно:</b> 10:00 - 21:00',
		'footer-location-title': 'Адрес',
		'nav-home': 'Главная',
		'nav-services': 'Услуги',
		'nav-work': 'Наши работы',
		'nav-contact': 'Контакты',
		'nav-products': 'Магазин',
	...
	ge: {
		...
		'footer-hours-desc': '<b>ღია ვართ ყოველდღე:</b> 10:00 - 21:00',
		'footer-location-title': 'მდებარეობა',
		'nav-home': 'მთავარი',
		'nav-services': 'სერვისები',
		'nav-work': 'ჩვენი ნამუშევრები',
		'nav-contact': 'კონტაქტი',
		'nav-products': 'მაღაზია',
